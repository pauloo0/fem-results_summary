...
function App() {
  return (
    <div className='h-screen w-screen flex sm:items-center sm:justify-center bg-white font-hanken-grotesk text-lg box-border'>
      <div className='max-w-4xl flex flex-col sm:flex-row rounded-3xl shadow-2xl bg-white'>
        <div
          id='score'
          className='sm:w-1/2 rounded-b-3xl sm:rounded-3xl bg-gradient-to-b from-light-slate-blue to-light-royal-blue py-8 sm:py-12 px-10 flex flex-col items-center justify-between text-center'
        >
          <h2 className='text-light-lavander text-xl sm:text-2xl'>
            Your Result
          </h2>
          <div
            id='circle'
            className='w-36 h-36 sm:w-48 sm:h-48 bg-gradient-to-b from-violet-blue to-persian-blue rounded-full flex flex-col items-center justify-center my-6'
          >
            <h1 className='text-5xl sm:text-6xl text-white font-extrabold'>
              76
            </h1>
            <p className='text-light-lavander text-base sm:text-lg mt-2'>
              of 100
            </p>
          </div>
          ...
          <p className='text-base sm:text-lg text-light-lavander font-medium'>
        ...
        <div
          id='summary'
          className='sm:w-1/2 py-8 sm:py-12 px-10 flex flex-col justify-between'
        >
